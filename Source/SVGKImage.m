...
- (UIImage *)highResUIImageAtScale:(CGFloat)scale {
#if SVGKIT_MAC
    return [SVGKExporterNSImage exportAsNSImage:self scale:scale antiAliased:TRUE curveFlatnessFactor:0.0f interpolationQuality:kCGInterpolationHigh]; // Apple defaults
#else
    return [SVGKExporterUIImage exportAsUIImage:self scale:scale antiAliased:TRUE curveFlatnessFactor:0.0f interpolationQuality:kCGInterpolationHigh]; // Apple defaults
#endif
}
